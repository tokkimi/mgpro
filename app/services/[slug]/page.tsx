...
export async function generateMetadata({params}:{params:Promise<{slug:string}>}){const {slug}=await params;const p=pages.find(p=>p.slug===slug);return {title:p?.title,description:p?.description}}
